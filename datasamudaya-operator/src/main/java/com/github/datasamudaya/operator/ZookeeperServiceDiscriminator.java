...
public class ZookeeperServiceDiscriminator implements ResourceDiscriminator<StatefulSet, DatasamudayaOperatorCustomResource>{
	...
	public Optional<StatefulSet> distinguish(Class<StatefulSet> statefulSetClass, DatasamudayaOperatorCustomResource resource,
		...
		InformerEventSource<StatefulSet, DatasamudayaOperatorCustomResource> ies =
		    ...
		    return ies.get(new ResourceID(DataSamudayaOperatorConstants.ZKSERVICEMETADATANAME,
